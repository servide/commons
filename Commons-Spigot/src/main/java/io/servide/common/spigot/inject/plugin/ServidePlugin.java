...
public abstract class ServidePlugin extends JavaPlugin implements Modular {
  ...
  public static Injector getInjector() {
    return JavaPlugin.getPlugin(ServidePlugin.class).injector;
  }

  public static boolean isModuleEnabled(Module module) {
    return ConfigModules
        .isModuleEnabled(module, JavaPlugin.getPlugin(ServidePlugin.class).moduleConfig);
  }
